...
export default function EditCellForm({ ref, edited, data_cols, dateFormat, db_connection, meters }) {
   ...
   if (edited)
   {
      ...
      new_val_input = create_input(edited_col, edited_val_type)
   }
...
function create_input(edited_col, edited_val_type) {
   //! Poner un switch en esta función.
   switch (edited_col)
   {
      ...
      case "deuda": return <input type="number" className="shortened" name={edited_col} min="0" step="0.01" inputMode="" required />
      case "multa": return <input type="number" className="shortened" name={edited_col} min="0" step="0.01" inputMode="" required />
      case "otros": return <input type="number" className="shortened" name={edited_col} min="0" step="0.01" inputMode="" required />
      case "crédito": return <input type="number" className="shortened" name={edited_col} min="0" step="0.01" inputMode="" required />
